...
import { transition, borderRadius } from '@shared/lib/helpers/style_utils';
    ...
    .ant-menu-submenu-vertical {
      ...
      .ant-menu-submenu-vertical {
        > li:not(.ant-menu-item-group) {
          ...
          */};
          padding-left: ${(props) => (props['data-rtl'] === 'rtl' ? '0px' : '74px')};
          padding-right: ${(props) => (props['data-rtl'] === 'rtl' ? '74px' : '0px')};
          font-size: 13px;
          font-weight: 400;
          margin: 0;
          color: inherit;
