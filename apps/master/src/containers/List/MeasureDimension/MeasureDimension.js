...
import actions from '../../../redux/list/measureDimension/actions';
...
class MeasureDimension extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${measureDimensionApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.measureDimension' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.measureDimensions.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.measureDimensions.fields.name' })} fixed={true} width={220} />
            <Column dataField='Ratio' dataType='number' caption={intl.formatMessage({ id: 'common.fields.ratio' })} width={150} />
          ...
          <ContextMenu
            ...
            target='#grdMeasureDimension .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.measureDimensions.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.measureDimensions.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.MeasureDimension.loading,
    create: {
      modelGet: state.MeasureDimension.create.modelGet,
      modelPost: state.MeasureDimension.create.modelPost,
      result: state.MeasureDimension.create.result,
      error: state.MeasureDimension.create.error,
      loading: state.MeasureDimension.create.loading,
      visible: state.MeasureDimension.create.visible,
    },
    edit: {
      modelGet: state.MeasureDimension.edit.modelGet,
      modelPost: state.MeasureDimension.edit.modelPost,
      result: state.MeasureDimension.edit.result,
      error: state.MeasureDimension.edit.error,
      loading: state.MeasureDimension.edit.loading,
      visible: state.MeasureDimension.edit.visible,
    },
    deletes: {
      modelPost: state.MeasureDimension.deletes.modelPost,
      result: state.MeasureDimension.deletes.result,
      error: state.MeasureDimension.deletes.error,
      loading: state.MeasureDimension.deletes.loading,
      visible: state.MeasureDimension.deletes.visible,
    },
    activates: {
      modelPost: state.MeasureDimension.activates.modelPost,
      result: state.MeasureDimension.activates.result,
      error: state.MeasureDimension.activates.error,
    },
    grd: {
      loading: state.MeasureDimension.grd.loading,
    },
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(MeasureDimension);
