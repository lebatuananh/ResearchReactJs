    ...
    return (
      <Spin spinning={loading} size='large'>
        ...
        >
          <Form.Item
            name='Code'
            label={<FormattedMessage id='admin.measureDimensions.fields.code' />}
            rules={[
              {
                required: true,
                message: (
                  <FormattedMessage id='common.validators.inputFields.required' values={{ field: <FormattedMessage id='admin.measureDimensions.fields.code' /> }} />
                ),
              },
            ]}
          >
...
function mapStateToProps(state) {
  return {
    model: state.MeasureDimension.create.modelGet,
