        ...
        <Tabs defaultActiveKey={tabSubmit} type='card' onChange={this.handleTabsChanged}>
          <TabPane tab={<FormattedMessage id='common.general' />} key='general'>
            ...
            >
              <Form.Item
                name='Code'
                label={<FormattedMessage id='admin.forwardingAgents.fields.code' />}
                rules={[
                  {
                    required: true,
                    message: (
                      <FormattedMessage
                        ...
                        values={{ field: <FormattedMessage id='admin.forwardingAgents.fields.code' /> }}
                      />
                    ),
                  },
                ]}
...
function mapStateToProps(state) {
  return {
    model: state.ForwardingAgent.create.modelGet,
