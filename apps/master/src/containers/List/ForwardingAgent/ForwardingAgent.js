...
class ForwardingAgent extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${forwardingAgentApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.forwardingAgent' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.forwardingAgents.fields.code' })} fixed={true} width={150} />
            <Column dataField='IATA' dataType='string' caption={intl.formatMessage({ id: 'common.fields.IATA' })} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.forwardingAgents.fields.name' })} fixed={true} width={220} />
            <Column dataField='LocalName' dataType='string' caption={intl.formatMessage({ id: 'common.fields.localName' })} width={220} />
            <Column dataField='CASS' dataType='string' caption={intl.formatMessage({ id: 'common.fields.CASS' })} width={150} />
            <Column dataField='StorageFreeDays' dataType='string' caption={intl.formatMessage({ id: 'common.fields.storageFreeDays' })} width={150} />
            <Column dataField='Website' dataType='string' caption={intl.formatMessage({ id: 'common.fields.website' })} width={150} />
          ...
          <ContextMenu
            ...
            target='#grdForwardingAgent .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.forwardingAgents.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.forwardingAgents.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.ForwardingAgent.loading,
    create: {
      modelGet: state.ForwardingAgent.create.modelGet,
      modelPost: state.ForwardingAgent.create.modelPost,
      result: state.ForwardingAgent.create.result,
      error: state.ForwardingAgent.create.error,
      loading: state.ForwardingAgent.create.loading,
      visible: state.ForwardingAgent.create.visible,
      visibleSubmit: state.ForwardingAgent.create.visibleSubmit,
    },
    edit: {
      modelGet: state.ForwardingAgent.edit.modelGet,
      modelPost: state.ForwardingAgent.edit.modelPost,
      result: state.ForwardingAgent.edit.result,
      error: state.ForwardingAgent.edit.error,
      loading: state.ForwardingAgent.edit.loading,
      visible: state.ForwardingAgent.edit.visible,
      visibleSubmit: state.ForwardingAgent.edit.visibleSubmit,
    },
    deletes: {
      modelPost: state.ForwardingAgent.deletes.modelPost,
      result: state.ForwardingAgent.deletes.result,
      error: state.ForwardingAgent.deletes.error,
      loading: state.ForwardingAgent.deletes.loading,
      visible: state.ForwardingAgent.deletes.visible,
    },
    activates: {
      modelPost: state.ForwardingAgent.activates.modelPost,
      result: state.ForwardingAgent.activates.result,
      error: state.ForwardingAgent.activates.error,
    },
    grd: {
      loading: state.ForwardingAgent.grd.loading,
    },
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(ForwardingAgent);
