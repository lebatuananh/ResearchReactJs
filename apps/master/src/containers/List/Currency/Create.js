    ...
    return (
      <Spin spinning={loading} size='large'>
        ...
        >
          <Form.Item
            name='CurrencyCode'
            label={<FormattedMessage id='admin.currencies.fields.currencyCode' />}
            rules={[
              {
                required: true,
                message: (
                  <FormattedMessage
                    ...
                    values={{ field: <FormattedMessage id='admin.currencies.fields.currencyCode' /> }}
                  />
                ),
              },
            ]}
...
function mapStateToProps(state) {
  return {
    model: state.Currency.create.modelGet,
