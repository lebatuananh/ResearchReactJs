...
import actions from '../../../redux/list/vendor/actions';
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${vendorApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.vendor' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.vendors.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.vendors.fields.name' })} fixed={true} width={220} />
          ...
          <ContextMenu
            ...
            target='#grdVendor .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.vendors.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.vendors.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    create: {
      modelGet: state.Vendor.create.modelGet,
      modelPost: state.Vendor.create.modelPost,
      result: state.Vendor.create.result,
      error: state.Vendor.create.error,
      loading: state.Vendor.create.loading,
      visible: state.Vendor.create.visible,
      visibleSubmit: state.Vendor.create.visibleSubmit,
    },
    edit: {
      modelGet: state.Vendor.edit.modelGet,
      modelPost: state.Vendor.edit.modelPost,
      result: state.Vendor.edit.result,
      error: state.Vendor.edit.error,
      loading: state.Vendor.edit.loading,
      visible: state.Vendor.edit.visible,
      visibleSubmit: state.Vendor.edit.visibleSubmit,
    },
    deletes: {
      modelPost: state.Vendor.deletes.modelPost,
      result: state.Vendor.deletes.result,
      error: state.Vendor.deletes.error,
      loading: state.Vendor.deletes.loading,
      visible: state.Vendor.deletes.visible,
    },
    activates: {
      modelPost: state.Vendor.activates.modelPost,
      result: state.Vendor.activates.result,
      error: state.Vendor.activates.error,
    },
    grd: {
      loading: state.Vendor.grd.loading,
    },
  };
}
