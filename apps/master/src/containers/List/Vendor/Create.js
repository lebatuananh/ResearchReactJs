        ...
        <Tabs defaultActiveKey={tabSubmit} type='card' onChange={this.handleTabsChanged}>
          <TabPane tab={<FormattedMessage id='common.general' />} key='general'>
            ...
            >
              <Form.Item
                name='Code'
                label={<FormattedMessage id='admin.vendors.fields.code' />}
                rules={[
                  {
                    required: true,
                    message: (
                      <FormattedMessage id='common.validators.inputFields.required' values={{ field: <FormattedMessage id='admin.vendors.fields.code' /> }} />
                    ),
                  },
                ]}
              >
              ...
              <LocalizedEditor
                ...
                standardRender={
                  <div>
                    <Form.Item
                      name='Name'
                      label={<FormattedMessage id='admin.vendors.fields.name' />}
                      rules={[
                        {
                          required: true,
                          message: (
                            <FormattedMessage
                              ...
                              values={{ field: <FormattedMessage id='admin.vendors.fields.name' /> }}
                            />
                          ),
                        },
                      ]}
...
function mapStateToProps(state) {
  return {
    model: state.Vendor.create.modelGet,
