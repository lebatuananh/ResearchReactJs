...
import actions from '../../../redux/list/incoterm/actions';
...
class Incoterm extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${incotermApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.incoterm' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.incoterms.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.incoterms.fields.name' })} fixed={true} width={220} />
            <Column dataField='LocalName' dataType='string' caption={intl.formatMessage({ id: 'common.fields.localName' })} width={150} />
            <Column
              dataField='FreightPMText'
              dataType='string'
              caption={intl.formatMessage({ id: 'admin.incoterms.fields.freightPaymentMethod' })}
              width={220}
            />
            <Column
              dataField='OtherChargesPMText'
              dataType='string'
              caption={intl.formatMessage({ id: 'admin.incoterms.fields.otherChargesPaymentMethod' })}
              width={250}
            />
          ...
          <ContextMenu
            ...
            target='#grdIncoterm .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.incoterms.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.incoterms.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.Incoterm.loading,
    create: {
      modelGet: state.Incoterm.create.modelGet,
      modelPost: state.Incoterm.create.modelPost,
      result: state.Incoterm.create.result,
      error: state.Incoterm.create.error,
      loading: state.Incoterm.create.loading,
      visible: state.Incoterm.create.visible,
    },
    edit: {
      modelGet: state.Incoterm.edit.modelGet,
      modelPost: state.Incoterm.edit.modelPost,
      result: state.Incoterm.edit.result,
      error: state.Incoterm.edit.error,
      loading: state.Incoterm.edit.loading,
      visible: state.Incoterm.edit.visible,
    },
    deletes: {
      modelPost: state.Incoterm.deletes.modelPost,
      result: state.Incoterm.deletes.result,
      error: state.Incoterm.deletes.error,
      loading: state.Incoterm.deletes.loading,
      visible: state.Incoterm.deletes.visible,
    },
    activates: {
      modelPost: state.Incoterm.activates.modelPost,
      result: state.Incoterm.activates.result,
      error: state.Incoterm.activates.error,
    },
    grd: {
      loading: state.Incoterm.grd.loading,
    },
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(Incoterm);
