...
import actions from '../../../redux/list/airline/actions';
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${api.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.airline' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.airlines.fields.code' })} fixed={true} width={150} />
            <Column dataField='Prefix' dataType='string' caption={intl.formatMessage({ id: 'common.fields.prefix' })} width={150} />
            <Column dataField='IATA' dataType='string' caption={intl.formatMessage({ id: 'common.fields.IATA' })} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.airlines.fields.name' })} fixed={true} width={220} />
          ...
          <ContextMenu
            ...
            target='#grdAirline .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.airlines.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.airlines.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.Airline.loading,
    create: {
      modelGet: state.Airline.create.modelGet,
      modelPost: state.Airline.create.modelPost,
      result: state.Airline.create.result,
      error: state.Airline.create.error,
      loading: state.Airline.create.loading,
      visible: state.Airline.create.visible,
    },
    edit: {
      modelGet: state.Airline.edit.modelGet,
      modelPost: state.Airline.edit.modelPost,
      result: state.Airline.edit.result,
      error: state.Airline.edit.error,
      loading: state.Airline.edit.loading,
      visible: state.Airline.edit.visible,
    },
    deletes: {
      modelPost: state.Airline.deletes.modelPost,
      result: state.Airline.deletes.result,
      error: state.Airline.deletes.error,
      loading: state.Airline.deletes.loading,
      visible: state.Airline.deletes.visible,
    },
    activates: {
      modelPost: state.Airline.activates.modelPost,
      result: state.Airline.activates.result,
      error: state.Airline.activates.error,
    },
    grd: {
      loading: state.Airline.grd.loading,
    },
  };
}
