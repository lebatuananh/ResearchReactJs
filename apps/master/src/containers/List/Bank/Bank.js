...
import actions from '../../../redux/list/bank/actions';
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${bankApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.banks.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.banks.fields.name' })} fixed={true} width={220} />
            <Column dataField='ShortName' dataType='string' caption={intl.formatMessage({ id: 'common.fields.shortName' })} width={150} />
            <Column dataField='SwiftCode' dataType='string' caption={intl.formatMessage({ id: 'admin.banks.fields.swiftCode' })} width={150} />
            <Column dataField='Logo' dataType='string' caption={intl.formatMessage({ id: 'common.fields.logo' })} width={220} />
          ...
          <ContextMenu
            ...
            target='#grdBank .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.banks.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.banks.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    create: {
      modelGet: state.Bank.create.modelGet,
      modelPost: state.Bank.create.modelPost,
      result: state.Bank.create.result,
      error: state.Bank.create.error,
      loading: state.Bank.create.loading,
      visible: state.Bank.create.visible,
    },
    edit: {
      modelGet: state.Bank.edit.modelGet,
      modelPost: state.Bank.edit.modelPost,
      result: state.Bank.edit.result,
      error: state.Bank.edit.error,
      loading: state.Bank.edit.loading,
      visible: state.Bank.edit.visible,
    },
    deletes: {
      modelPost: state.Bank.deletes.modelPost,
      result: state.Bank.deletes.result,
      error: state.Bank.deletes.error,
      loading: state.Bank.deletes.loading,
      visible: state.Bank.deletes.visible,
    },
    activates: {
      modelPost: state.Bank.activates.modelPost,
      result: state.Bank.activates.result,
      error: state.Bank.activates.error,
    },
    grd: {
      loading: state.Bank.grd.loading,
    },
  };
}
