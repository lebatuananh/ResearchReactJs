    ...
    return (
      <Spin spinning={loading} size='large'>
        ...
        >
          <Form.Item
            name='Code'
            label={<FormattedMessage id='admin.banks.fields.code' />}
            rules={[
              {
                required: true,
                message: <FormattedMessage id='common.validators.inputFields.required' values={{ field: <FormattedMessage id='admin.banks.fields.code' /> }} />,
              },
            ]}
          >
...
function mapStateToProps(state) {
  return {
    model: state.Bank.create.modelGet,
