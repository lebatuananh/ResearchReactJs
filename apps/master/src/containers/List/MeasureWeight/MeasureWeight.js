...
import actions from '../../../redux/list/measureWeight/actions';
...
class MeasureWeight extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${measureWeightApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.measureWeight' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.measureWeights.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.measureWeights.fields.name' })} fixed={true} width={220} />
          ...
          <ContextMenu
            ...
            target='#grdMeasureWeight .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.measureWeights.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.measureWeights.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.MeasureWeight.loading,
    create: {
      modelGet: state.MeasureWeight.create.modelGet,
      modelPost: state.MeasureWeight.create.modelPost,
      result: state.MeasureWeight.create.result,
      error: state.MeasureWeight.create.error,
      loading: state.MeasureWeight.create.loading,
      visible: state.MeasureWeight.create.visible,
    },
    edit: {
      modelGet: state.MeasureWeight.edit.modelGet,
      modelPost: state.MeasureWeight.edit.modelPost,
      result: state.MeasureWeight.edit.result,
      error: state.MeasureWeight.edit.error,
      loading: state.MeasureWeight.edit.loading,
      visible: state.MeasureWeight.edit.visible,
    },
    deletes: {
      modelPost: state.MeasureWeight.deletes.modelPost,
      result: state.MeasureWeight.deletes.result,
      error: state.MeasureWeight.deletes.error,
      loading: state.MeasureWeight.deletes.loading,
      visible: state.MeasureWeight.deletes.visible,
    },
    activates: {
      modelPost: state.MeasureWeight.activates.modelPost,
      result: state.MeasureWeight.activates.result,
      error: state.MeasureWeight.activates.error,
    },
    grd: {
      loading: state.MeasureWeight.grd.loading,
    },
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(MeasureWeight);
