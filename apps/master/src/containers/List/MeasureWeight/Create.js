    ...
    return (
      <Spin spinning={loading} size='large'>
        ...
        >
          <Form.Item
            name='Code'
            label={<FormattedMessage id='admin.measureWeights.fields.code' />}
            rules={[
              {
                required: true,
                message: (
                  <FormattedMessage id='common.validators.inputFields.required' values={{ field: <FormattedMessage id='admin.measureWeights.fields.code' /> }} />
                ),
              },
            ]}
          >
          ...
          <LocalizedEditor
            ...
            standardRender={
              <div>
                <Form.Item
                  name='Name'
                  label={<FormattedMessage id='admin.measureWeights.fields.name' />}
                  rules={[
                    {
                      required: true,
                      message: (
                        <FormattedMessage
                          ...
                          values={{ field: <FormattedMessage id='admin.measureWeights.fields.name' /> }}
                        />
                      ),
                    },
                  ]}
...
function mapStateToProps(state) {
  return {
    model: state.MeasureWeight.create.modelGet,
