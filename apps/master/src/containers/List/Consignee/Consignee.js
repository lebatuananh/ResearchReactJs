...
import actions from '../../../redux/list/consignee/actions';
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${consigneeApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.consignees.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.consignees.fields.name' })} fixed={true} width={220} />
          ...
          <ContextMenu
            ...
            target='#grdConsignee .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.consignees.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.consignees.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.Consignee.loading,
    create: {
      modelGet: state.Consignee.create.modelGet,
      modelPost: state.Consignee.create.modelPost,
      result: state.Consignee.create.result,
      error: state.Consignee.create.error,
      loading: state.Consignee.create.loading,
      visible: state.Consignee.create.visible,
      visibleSubmit: state.Consignee.create.visibleSubmit,
    },
    edit: {
      modelGet: state.Consignee.edit.modelGet,
      modelPost: state.Consignee.edit.modelPost,
      result: state.Consignee.edit.result,
      error: state.Consignee.edit.error,
      loading: state.Consignee.edit.loading,
      visible: state.Consignee.edit.visible,
      visibleSubmit: state.Consignee.edit.visibleSubmit,
    },
    deletes: {
      modelPost: state.Consignee.deletes.modelPost,
      result: state.Consignee.deletes.result,
      error: state.Consignee.deletes.error,
      loading: state.Consignee.deletes.loading,
      visible: state.Consignee.deletes.visible,
    },
    activates: {
      modelPost: state.Consignee.activates.modelPost,
      result: state.Consignee.activates.result,
      error: state.Consignee.activates.error,
    },
    grd: {
      loading: state.Consignee.grd.loading,
    },
  };
}
