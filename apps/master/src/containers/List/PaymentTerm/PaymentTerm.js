...
import actions from '../../../redux/list/paymentTerm/actions';
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${paymentTermApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.paymentTerm' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.paymentTerms.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.paymentTerms.fields.name' })} fixed={true} width={220} />
            ...
            <Column
              ...
              dataType='boolean'
              caption={intl.formatMessage({ id: 'admin.paymentTerms.fields.currentMonth' })}
              width={120}
              cellRender={CellActive}
            />
            <Column dataField='Days' dataType='number' caption={intl.formatMessage({ id: 'common.fields.days' })} width={100} />
            <Column dataField='FromDateTypeText' dataType='string' caption={intl.formatMessage({ id: 'admin.paymentTerms.fields.fromDateType' })} width={150} />
            <Column dataField='Description' dataType='string' caption={intl.formatMessage({ id: 'common.fields.description' })} minWidth={300} />
            <Column
              dataField='Active'
              dataType='bool'
          ...
          <ContextMenu
            ...
            target='#grdPaymentTerm .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.paymentTerms.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.paymentTerms.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    create: {
      modelGet: state.PaymentTerm.create.modelGet,
      modelPost: state.PaymentTerm.create.modelPost,
      result: state.PaymentTerm.create.result,
      error: state.PaymentTerm.create.error,
      loading: state.PaymentTerm.create.loading,
      visible: state.PaymentTerm.create.visible,
    },
    edit: {
      modelGet: state.PaymentTerm.edit.modelGet,
      modelPost: state.PaymentTerm.edit.modelPost,
      result: state.PaymentTerm.edit.result,
      error: state.PaymentTerm.edit.error,
      loading: state.PaymentTerm.edit.loading,
      visible: state.PaymentTerm.edit.visible,
    },
    deletes: {
      modelPost: state.PaymentTerm.deletes.modelPost,
      result: state.PaymentTerm.deletes.result,
      error: state.PaymentTerm.deletes.error,
      loading: state.PaymentTerm.deletes.loading,
      visible: state.PaymentTerm.deletes.visible,
    },
    activates: {
      modelPost: state.PaymentTerm.activates.modelPost,
      result: state.PaymentTerm.activates.result,
      error: state.PaymentTerm.activates.error,
    },
    grd: {
      loading: state.PaymentTerm.grd.loading,
    },
  };
}
