        ...
        <Tabs defaultActiveKey={tabSubmit} type='card' onChange={this.handleTabsChanged}>
          <TabPane tab={<FormattedMessage id='common.general' />} key='general'>
            ...
            >
              <Form.Item
                name='Code'
                label={<FormattedMessage id='admin.customAgents.fields.code' />}
                rules={[
                  {
                    required: true,
                    message: (
                      <FormattedMessage
                        ...
                        values={{ field: <FormattedMessage id='admin.customAgents.fields.code' /> }}
                      />
                    ),
                  },
                ]}
              ...
              <LocalizedEditor
                id='localized_CustomAgent'
                locales={m.Locales}
                standardRender={
                  <div>
                    <Form.Item
                      name='Name'
                      label={<FormattedMessage id='admin.customAgents.fields.name' />}
                      rules={[
                        {
                          required: true,
                          message: (
                            <FormattedMessage
                              id='common.validators.inputFields.required'
                              values={{ field: <FormattedMessage id='admin.customAgents.fields.name' /> }}
                            />
                          ),
                        },
                      ]}
...
function mapStateToProps(state) {
  return {
    model: state.CustomAgent.create.modelGet,
