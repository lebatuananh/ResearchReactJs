...
import actions from '../../../redux/list/customAgent/actions';
...
class CustomAgent extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${customAgentApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.customAgent' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.customAgents.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.customAgents.fields.name' })} fixed={true} width={220} />
          ...
          <ContextMenu
            ...
            target='#grdCustomAgent .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.customAgents.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.customAgents.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.CustomAgent.loading,
    create: {
      modelGet: state.CustomAgent.create.modelGet,
      modelPost: state.CustomAgent.create.modelPost,
      result: state.CustomAgent.create.result,
      error: state.CustomAgent.create.error,
      loading: state.CustomAgent.create.loading,
      visible: state.CustomAgent.create.visible,
      visibleSubmit: state.CustomAgent.create.visibleSubmit,
    },
    edit: {
      modelGet: state.CustomAgent.edit.modelGet,
      modelPost: state.CustomAgent.edit.modelPost,
      result: state.CustomAgent.edit.result,
      error: state.CustomAgent.edit.error,
      loading: state.CustomAgent.edit.loading,
      visible: state.CustomAgent.edit.visible,
      visibleSubmit: state.CustomAgent.edit.visibleSubmit,
    },
    deletes: {
      modelPost: state.CustomAgent.deletes.modelPost,
      result: state.CustomAgent.deletes.result,
      error: state.CustomAgent.deletes.error,
      loading: state.CustomAgent.deletes.loading,
      visible: state.CustomAgent.deletes.visible,
    },
    activates: {
      modelPost: state.CustomAgent.activates.modelPost,
      result: state.CustomAgent.activates.result,
      error: state.CustomAgent.activates.error,
    },
    grd: {
      loading: state.CustomAgent.grd.loading,
    },
  };
}
