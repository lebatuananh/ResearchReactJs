...
import actions from '../../../redux/list/packageType/actions';
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${packageTypeApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.packageType' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.packageTypes.fields.code' })} fixed={true} width={220} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.packageTypes.fields.name' })} fixed={true} minWidth={220} />
            <Column dataField='LocalName' dataType='string' caption={intl.formatMessage({ id: 'common.fields.localName' })} width={150} />
            <Column dataField='TEU' dataType='number' caption={intl.formatMessage({ id: 'admin.packageTypes.fields.TEU' })} width={150} />
            <Column dataField='ContainerSize' dataType='number' caption={intl.formatMessage({ id: 'admin.packageTypes.fields.containerSize' })} width={150} />
            <Column dataField='Volume' dataType='number' caption={intl.formatMessage({ id: 'common.fields.volume' })} width={150} />
            <Column dataField='PrintAs' dataType='string' caption={intl.formatMessage({ id: 'common.fields.printAs' })} width={150} />
            <Column
              dataField='IsContainer'
              dataType='boolean'
              caption={intl.formatMessage({ id: 'admin.packageTypes.fields.isContainer' })}
              width={120}
              cellRender={CellActive}
            />
            <Column
              dataField='Refrigerated'
              dataType='boolean'
              caption={intl.formatMessage({ id: 'admin.packageTypes.fields.refrigerated' })}
              width={120}
              cellRender={CellActive}
            />
            <Column dataField='Vehicle' dataType='boolean' caption={intl.formatMessage({ id: 'common.fields.vehicle' })} width={120} cellRender={CellActive} />
            <Column dataField='Air' dataType='boolean' caption={intl.formatMessage({ id: 'common.fields.air' })} width={120} cellRender={CellActive} />
            <Column dataField='Ocean' dataType='boolean' caption={intl.formatMessage({ id: 'common.fields.ocean' })} width={120} cellRender={CellActive} />
            <Column dataField='Inland' dataType='boolean' caption={intl.formatMessage({ id: 'common.fields.inland' })} width={120} cellRender={CellActive} />
          ...
          <ContextMenu
            ...
            target='#grdPackageType .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.packageTypes.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.packageTypes.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.PackageType.loading,
    create: {
      modelGet: state.PackageType.create.modelGet,
      modelPost: state.PackageType.create.modelPost,
      result: state.PackageType.create.result,
      error: state.PackageType.create.error,
      loading: state.PackageType.create.loading,
      visible: state.PackageType.create.visible,
    },
    edit: {
      modelGet: state.PackageType.edit.modelGet,
      modelPost: state.PackageType.edit.modelPost,
      result: state.PackageType.edit.result,
      error: state.PackageType.edit.error,
      loading: state.PackageType.edit.loading,
      visible: state.PackageType.edit.visible,
    },
    deletes: {
      modelPost: state.PackageType.deletes.modelPost,
      result: state.PackageType.deletes.result,
      error: state.PackageType.deletes.error,
      loading: state.PackageType.deletes.loading,
      visible: state.PackageType.deletes.visible,
    },
    activates: {
      modelPost: state.PackageType.activates.modelPost,
      result: state.PackageType.activates.result,
      error: state.PackageType.activates.error,
    },
    grd: {
      loading: state.PackageType.grd.loading,
    },
  };
}
