        ...
        >
          <Row gutter={24}>
            <Col {...layoutFormLeft}>
              <Form.Item
                name='Code'
                label={<FormattedMessage id='admin.packageTypes.fields.code' />}
                rules={[
                  {
                    required: true,
                    message: (
                      <FormattedMessage
                        ...
                        values={{ field: <FormattedMessage id='admin.packageTypes.fields.code' /> }}
                      />
                    ),
                  },
                ]}
...
function mapStateToProps(state) {
  return {
    model: state.PackageType.create.modelGet,
