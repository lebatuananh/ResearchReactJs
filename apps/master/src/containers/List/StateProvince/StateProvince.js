...
import actions from '../../../redux/list/stateProvince/actions';
...
class StateProvince extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${stateProvinceApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.stateProvince' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.stateProvinces.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.stateProvinces.fields.name' })} fixed={true} width={220} />
            <Column dataField='ShortName' dataType='string' caption={intl.formatMessage({ id: 'common.fields.shortName' })} width={150} />
            <Column dataField='Country.Name' dataType='string' caption={intl.formatMessage({ id: 'common.country' })} width={220} />
          ...
          <ContextMenu
            ...
            target='#grdStateProvince .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.stateProvinces.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.stateProvinces.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.StateProvince.loading,
    init: state.StateProvince.init,
    search: {
      countries: state.StateProvince.search.countries,
    },
    create: {
      modelGet: state.StateProvince.create.modelGet,
      modelPost: state.StateProvince.create.modelPost,
      result: state.StateProvince.create.result,
      error: state.StateProvince.create.error,
      loading: state.StateProvince.create.loading,
      visible: state.StateProvince.create.visible,
    },
    edit: {
      modelGet: state.StateProvince.edit.modelGet,
      modelPost: state.StateProvince.edit.modelPost,
      result: state.StateProvince.edit.result,
      error: state.StateProvince.edit.error,
      loading: state.StateProvince.edit.loading,
      visible: state.StateProvince.edit.visible,
    },
    deletes: {
      modelPost: state.StateProvince.deletes.modelPost,
      result: state.StateProvince.deletes.result,
      error: state.StateProvince.deletes.error,
      loading: state.StateProvince.deletes.loading,
      visible: state.StateProvince.deletes.visible,
    },
    activates: {
      modelPost: state.StateProvince.activates.modelPost,
      result: state.StateProvince.activates.result,
      error: state.StateProvince.activates.error,
    },
    grd: {
      loading: state.StateProvince.grd.loading,
    },
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(StateProvince);
