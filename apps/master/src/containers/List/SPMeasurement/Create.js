    ...
    return (
      <Spin spinning={loading} size='large'>
        ...
        >
          <Form.Item
            name='Code'
            label={<FormattedMessage id='admin.sPMeasurements.fields.code' />}
            rules={[
              {
                required: true,
                message: (
                  <FormattedMessage
                    ...
                    values={{ field: <FormattedMessage id='admin.sPMeasurements.fields.code' /> }}
                  />
                ),
              },
            ]}
...
function mapStateToProps(state) {
  return {
    model: state.SPMeasurement.create.modelGet,
