...
import actions from '../../../redux/list/sPMeasurement/actions';
...
class SPMeasurement extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${sPMeasurementApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.sPMeasurement' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.sPMeasurements.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.sPMeasurements.fields.name' })} fixed={true} width={220} />
            ...
            <Column
              ...
              dataType='boolean'
              caption={intl.formatMessage({ id: 'admin.sPMeasurements.fields.isContainer' })}
              width={150}
              cellRender={CellActive}
            />
            <Column
              dataField='IsContainerMeasurement'
              dataType='boolean'
              caption={intl.formatMessage({ id: 'admin.sPMeasurements.fields.isContainerMeasurement' })}
              width={150}
              cellRender={CellActive}
            />
          ...
          <ContextMenu
            ...
            target='#grdSPMeasurement .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.sPMeasurements.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.sPMeasurements.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.SPMeasurement.loading,
    create: {
      modelGet: state.SPMeasurement.create.modelGet,
      modelPost: state.SPMeasurement.create.modelPost,
      result: state.SPMeasurement.create.result,
      error: state.SPMeasurement.create.error,
      loading: state.SPMeasurement.create.loading,
      visible: state.SPMeasurement.create.visible,
    },
    edit: {
      modelGet: state.SPMeasurement.edit.modelGet,
      modelPost: state.SPMeasurement.edit.modelPost,
      result: state.SPMeasurement.edit.result,
      error: state.SPMeasurement.edit.error,
      loading: state.SPMeasurement.edit.loading,
      visible: state.SPMeasurement.edit.visible,
    },
    deletes: {
      modelPost: state.SPMeasurement.deletes.modelPost,
      result: state.SPMeasurement.deletes.result,
      error: state.SPMeasurement.deletes.error,
      loading: state.SPMeasurement.deletes.loading,
      visible: state.SPMeasurement.deletes.visible,
    },
    activates: {
      modelPost: state.SPMeasurement.activates.modelPost,
      result: state.SPMeasurement.activates.result,
      error: state.SPMeasurement.activates.error,
    },
    grd: {
      loading: state.SPMeasurement.grd.loading,
    },
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(SPMeasurement);
