...
import actions from '../../../redux/list/sPCustomer/actions';
...
class SPCustomer extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${sPCustomerApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.sPCustomers.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.sPCustomers.fields.name' })} fixed={true} width={220} />
            <Column dataField='LocalName' dataType='string' caption={intl.formatMessage({ id: 'common.fields.localName' })} minWidth={220} />
            <Column dataField='VatNumber' dataType='string' caption={intl.formatMessage({ id: 'common.fields.vatNumber' })} width={150} />
            <Column dataField='PaymentTerm.Name' dataType='string' caption={intl.formatMessage({ id: 'common.paymentTerm' })} width={150} />
            <Column dataField='StorageFreeDays' dataType='string' caption={intl.formatMessage({ id: 'common.fields.storageFreeDays' })} width={150} />
            <Column dataField='Website' dataType='string' caption={intl.formatMessage({ id: 'common.fields.website' })} minWidth={150} />
            <Column
              dataField='Active'
              dataType='bool'
          ...
          <ContextMenu
            ...
            target='#grdSPCustomer .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.sPCustomers.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.sPCustomers.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.SPCustomer.loading,
    create: {
      modelGet: state.SPCustomer.create.modelGet,
      modelPost: state.SPCustomer.create.modelPost,
      result: state.SPCustomer.create.result,
      error: state.SPCustomer.create.error,
      loading: state.SPCustomer.create.loading,
      visible: state.SPCustomer.create.visible,
      visibleSubmit: state.SPCustomer.create.visibleSubmit,
    },
    edit: {
      modelGet: state.SPCustomer.edit.modelGet,
      modelPost: state.SPCustomer.edit.modelPost,
      result: state.SPCustomer.edit.result,
      error: state.SPCustomer.edit.error,
      loading: state.SPCustomer.edit.loading,
      visible: state.SPCustomer.edit.visible,
      visibleSubmit: state.SPCustomer.edit.visibleSubmit,
    },
    deletes: {
      modelPost: state.SPCustomer.deletes.modelPost,
      result: state.SPCustomer.deletes.result,
      error: state.SPCustomer.deletes.error,
      loading: state.SPCustomer.deletes.loading,
      visible: state.SPCustomer.deletes.visible,
    },
    activates: {
      modelPost: state.SPCustomer.activates.modelPost,
      result: state.SPCustomer.activates.result,
      error: state.SPCustomer.activates.error,
    },
    grd: {
      loading: state.SPCustomer.grd.loading,
    },
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(SPCustomer);
