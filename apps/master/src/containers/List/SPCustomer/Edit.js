        ...
        <Tabs defaultActiveKey={tabSubmit} type='card' onChange={this.handleTabsChanged}>
          <TabPane tab={<FormattedMessage id='common.general' />} key='general'>
            ...
            >
              ...
              <Form.Item name='Code' label={<FormattedMessage id='admin.sPCustomers.fields.code' />}>
                <Input disabled />
              </Form.Item>
              <LocalizedEditor
                id='localized_SPCustomer'
                locales={m.Locales}
                standardRender={
                  <div>
                    <Form.Item
                      name='Name'
                      label={<FormattedMessage id='admin.sPCustomers.fields.name' />}
                      rules={[
                        {
                          required: true,
                          message: (
                            <FormattedMessage
                              ...
                              values={{ field: <FormattedMessage id='admin.sPCustomers.fields.name' /> }}
                            />
                          ),
                        },
                      ]}
...
function mapStateToProps(state) {
  return {
    model: state.SPCustomer.edit.modelGet,
