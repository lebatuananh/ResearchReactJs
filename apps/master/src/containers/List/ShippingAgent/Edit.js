          ...
          <TabPane tab={<FormattedMessage id='common.general' />} key='general'>
            <Form
              ...
              initialValues={{
                ...
                ForwarderAccountNumber: m.ForwarderAccountNumber,
                ForwarderCreditNumber: m.ForwarderCreditNumber,
                LocalCustomsCode: m.LocalCustomsCode,
                Website: m.Website,
                Note: m.Note,
                Active: m.Active,
                Locales: m.Locales,
            ...
            >
              ...
              <Form.Item name='Code' label={<FormattedMessage id='admin.shippingAgents.fields.code' />}>
                <Input disabled />
              </Form.Item>
...
function mapStateToProps(state) {
  return {
    model: state.ShippingAgent.edit.modelGet,
