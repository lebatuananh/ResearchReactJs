...
class ShippingAgent extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${shippingAgentApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.shippingAgent' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.shippingAgents.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.shippingAgents.fields.name' })} fixed={true} width={220} />
            <Column dataField='LocalName' dataType='string' caption={intl.formatMessage({ id: 'common.fields.localName' })} width={220} />
            <Column
              dataField='ForwarderAccountNumber'
              dataType='string'
              caption={intl.formatMessage({ id: 'admin.shippingAgents.fields.forwarderAccountNumber' })}
              width={150}
            />
            <Column
              dataField='ForwarderCreditNumber'
              dataType='string'
              caption={intl.formatMessage({ id: 'admin.shippingAgents.fields.forwarderCreditNumber' })}
              width={150}
            />
            <Column
              dataField='LocalCustomsCode'
              dataType='string'
              caption={intl.formatMessage({ id: 'admin.shippingAgents.fields.localCustomsCode' })}
              width={150}
            />
          ...
          <ContextMenu
            ...
            target='#grdShippingAgent .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.shippingAgents.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.shippingAgents.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.ShippingAgent.loading,
    create: {
      modelGet: state.ShippingAgent.create.modelGet,
      modelPost: state.ShippingAgent.create.modelPost,
      result: state.ShippingAgent.create.result,
      error: state.ShippingAgent.create.error,
      loading: state.ShippingAgent.create.loading,
      visible: state.ShippingAgent.create.visible,
      visibleSubmit: state.ShippingAgent.create.visibleSubmit,
    },
    edit: {
      modelGet: state.ShippingAgent.edit.modelGet,
      modelPost: state.ShippingAgent.edit.modelPost,
      result: state.ShippingAgent.edit.result,
      error: state.ShippingAgent.edit.error,
      loading: state.ShippingAgent.edit.loading,
      visible: state.ShippingAgent.edit.visible,
      visibleSubmit: state.ShippingAgent.edit.visibleSubmit,
    },
    deletes: {
      modelPost: state.ShippingAgent.deletes.modelPost,
      result: state.ShippingAgent.deletes.result,
      error: state.ShippingAgent.deletes.error,
      loading: state.ShippingAgent.deletes.loading,
      visible: state.ShippingAgent.deletes.visible,
    },
    activates: {
      modelPost: state.ShippingAgent.activates.modelPost,
      result: state.ShippingAgent.activates.result,
      error: state.ShippingAgent.activates.error,
    },
    grd: {
      loading: state.ShippingAgent.grd.loading,
    },
  };
}
