...
import actions from '../../../redux/list/commodity/actions';
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${commodityApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.commodity' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.commodities.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.commodities.fields.name' })} fixed={true} width={220} />
            <Column dataField='LocalName' dataType='string' caption={intl.formatMessage({ id: 'common.fields.localName' })} width={250} />
            <Column dataField='CommodityGroup.Name' dataType='string' caption={intl.formatMessage({ id: 'common.commodityGroup' })} width={250} />
          ...
          <ContextMenu
            ...
            target='#grdCommodity .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.commodities.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.commodities.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    create: {
      modelGet: state.Commodity.create.modelGet,
      modelPost: state.Commodity.create.modelPost,
      result: state.Commodity.create.result,
      error: state.Commodity.create.error,
      loading: state.Commodity.create.loading,
      visible: state.Commodity.create.visible,
    },
    edit: {
      modelGet: state.Commodity.edit.modelGet,
      modelPost: state.Commodity.edit.modelPost,
      result: state.Commodity.edit.result,
      error: state.Commodity.edit.error,
      loading: state.Commodity.edit.loading,
      visible: state.Commodity.edit.visible,
    },
    deletes: {
      modelPost: state.Commodity.deletes.modelPost,
      result: state.Commodity.deletes.result,
      error: state.Commodity.deletes.error,
      loading: state.Commodity.deletes.loading,
      visible: state.Commodity.deletes.visible,
    },
    activates: {
      modelPost: state.Commodity.activates.modelPost,
      result: state.Commodity.activates.result,
      error: state.Commodity.activates.error,
    },
    grd: {
      loading: state.Commodity.grd.loading,
    },
  };
}
