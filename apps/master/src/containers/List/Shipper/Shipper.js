  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${shipperApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.shipper' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.shippers.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.shippers.fields.name' })} fixed={true} width={220} />
          ...
          <ContextMenu
            ...
            target='#grdShipper .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.shippers.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.shippers.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.Shipper.loading,
    create: {
      modelGet: state.Shipper.create.modelGet,
      modelPost: state.Shipper.create.modelPost,
      result: state.Shipper.create.result,
      error: state.Shipper.create.error,
      loading: state.Shipper.create.loading,
      visible: state.Shipper.create.visible,
      visibleSubmit: state.Shipper.create.visibleSubmit,
    },
    edit: {
      modelGet: state.Shipper.edit.modelGet,
      modelPost: state.Shipper.edit.modelPost,
      result: state.Shipper.edit.result,
      error: state.Shipper.edit.error,
      loading: state.Shipper.edit.loading,
      visible: state.Shipper.edit.visible,
      visibleSubmit: state.Shipper.edit.visibleSubmit,
    },
    deletes: {
      modelPost: state.Shipper.deletes.modelPost,
      result: state.Shipper.deletes.result,
      error: state.Shipper.deletes.error,
      loading: state.Shipper.deletes.loading,
      visible: state.Shipper.deletes.visible,
    },
    activates: {
      modelPost: state.Shipper.activates.modelPost,
      result: state.Shipper.activates.result,
      error: state.Shipper.activates.error,
    },
    grd: {
      loading: state.Shipper.grd.loading,
    },
  };
}
