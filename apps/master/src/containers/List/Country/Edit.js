    ...
    return (
      <Spin spinning={loading} size='large'>
        ...
        >
          ...
          <Form.Item name='Code' label={<FormattedMessage id='admin.countries.fields.code' />}>
            <Input disabled />
          </Form.Item>
          <LocalizedEditor
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: <FormattedMessage id='common.globalZone' />,
              },
            ]}
          >
            <Select
...
function mapStateToProps(state) {
  return {
    model: state.Country.edit.modelGet,
