...
import actions from '../../../redux/list/vessel/actions';
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${vesselApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.vessel' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.vessels.fields.name' })} fixed={true} width={220} />
            <Column dataField='IMOCode' dataType='string' caption={intl.formatMessage({ id: 'common.fields.IMOCode' })} fixed={true} width={150} />
          ...
          <ContextMenu
            ...
            target='#grdVessel .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.vessels.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.vessels.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    init: state.Vessel.init,
    search: {
      countries: state.Vessel.search.countries,
    },
    create: {
      modelGet: state.Vessel.create.modelGet,
      modelPost: state.Vessel.create.modelPost,
      result: state.Vessel.create.result,
      error: state.Vessel.create.error,
      loading: state.Vessel.create.loading,
      visible: state.Vessel.create.visible,
    },
    edit: {
      modelGet: state.Vessel.edit.modelGet,
      modelPost: state.Vessel.edit.modelPost,
      result: state.Vessel.edit.result,
      error: state.Vessel.edit.error,
      loading: state.Vessel.edit.loading,
      visible: state.Vessel.edit.visible,
    },
    deletes: {
      modelPost: state.Vessel.deletes.modelPost,
      result: state.Vessel.deletes.result,
      error: state.Vessel.deletes.error,
      loading: state.Vessel.deletes.loading,
      visible: state.Vessel.deletes.visible,
    },
    activates: {
      modelPost: state.Vessel.activates.modelPost,
      result: state.Vessel.activates.result,
      error: state.Vessel.activates.error,
    },
    grd: {
      loading: state.Vessel.grd.loading,
    },
  };
}
