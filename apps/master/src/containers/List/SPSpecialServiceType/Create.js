    ...
    return (
      <Spin spinning={loading} size='large'>
        ...
        >
          <Form.Item
            name='Code'
            label={<FormattedMessage id='admin.sPSpecialServiceTypes.fields.code' />}
            rules={[
              {
                required: true,
                message: (
                  <FormattedMessage
                    ...
                    values={{ field: <FormattedMessage id='admin.sPSpecialServiceTypes.fields.code' /> }}
                  />
                ),
              },
            ]}
...
function mapStateToProps(state) {
  return {
    model: state.SPSpecialServiceType.create.modelGet,
