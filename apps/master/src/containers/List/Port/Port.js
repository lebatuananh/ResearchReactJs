  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${portApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.ports.fields.code' })} fixed={true} width={150} />
            <Column dataField='ShortName' dataType='string' caption={intl.formatMessage({ id: 'common.fields.shortName' })} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.ports.fields.name' })} fixed={true} width={220} />
            ...
            <Column dataField='Air' cellRender={CellActive} dataType='boolean' caption={intl.formatMessage({ id: 'common.fields.air' })} width={70} />
            <Column dataField='Ocean' cellRender={CellActive} dataType='boolean' caption={intl.formatMessage({ id: 'common.fields.ocean' })} width={70} />
            <Column dataField='Inland' cellRender={CellActive} dataType='boolean' caption={intl.formatMessage({ id: 'common.fields.inland' })} width={70} />
            <Column
              dataField='Active'
              dataType='bool'
          ...
          <ContextMenu
            ...
            target='#grdPort .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.ports.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.ports.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    create: {
      modelGet: state.Port.create.modelGet,
      modelPost: state.Port.create.modelPost,
      result: state.Port.create.result,
      error: state.Port.create.error,
      loading: state.Port.create.loading,
      visible: state.Port.create.visible,
      data: {
        stateProvince: {
          error: state.Port.create.data.stateProvince.error,
        },
      },
    },
    edit: {
      modelGet: state.Port.edit.modelGet,
      modelPost: state.Port.edit.modelPost,
      result: state.Port.edit.result,
      error: state.Port.edit.error,
      loading: state.Port.edit.loading,
      visible: state.Port.edit.visible,
      data: {
        stateProvince: {
          error: state.Port.edit.data.stateProvince.error,
        },
      },
    },
    deletes: {
      modelPost: state.Port.deletes.modelPost,
      result: state.Port.deletes.result,
      error: state.Port.deletes.error,
      loading: state.Port.deletes.loading,
      visible: state.Port.deletes.visible,
    },
    activates: {
      modelPost: state.Port.activates.modelPost,
      result: state.Port.activates.result,
      error: state.Port.activates.error,
    },
    grd: {
      loading: state.Port.grd.loading,
    },
  };
}
