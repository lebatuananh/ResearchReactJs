    ...
    return (
      <Spin spinning={loading} size='large'>
        ...
        >
          ...
          <Form.Item name='Code' label={<FormattedMessage id='admin.sPProductTypes.fields.code' />}>
            <Input disabled />
          </Form.Item>
          <LocalizedEditor
            id='localized_SPProductType'
            locales={m.Locales}
            standardRender={
              <div>
                <Form.Item
                  name='Name'
                  label={<FormattedMessage id='admin.sPProductTypes.fields.name' />}
                  rules={[
                    {
                      required: true,
                      message: (
                        <FormattedMessage
                          ...
                          values={{ field: <FormattedMessage id='admin.sPProductTypes.fields.name' /> }}
                        />
                      ),
                    },
                  ]}
...
function mapStateToProps(state) {
  return {
    model: state.SPProductType.edit.modelGet,
