...
import actions from '../../../redux/list/chargesGroup/actions';
...
class ChargesGroup extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${chargesGroupApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.chargesGroup' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.chargesGroups.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.chargesGroups.fields.name' })} fixed={true} minWidth={220} />
            <Column dataField='LocalName' dataType='string' caption={intl.formatMessage({ id: 'common.fields.localName' })} minWidth={250} />
            <Column
              dataField='Active'
              dataType='bool'
          ...
          <ContextMenu
            ...
            target='#grdChargesGroup .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.chargesGroups.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.chargesGroups.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.ChargesGroup.loading,
    create: {
      modelGet: state.ChargesGroup.create.modelGet,
      modelPost: state.ChargesGroup.create.modelPost,
      result: state.ChargesGroup.create.result,
      error: state.ChargesGroup.create.error,
      loading: state.ChargesGroup.create.loading,
      visible: state.ChargesGroup.create.visible,
    },
    edit: {
      modelGet: state.ChargesGroup.edit.modelGet,
      modelPost: state.ChargesGroup.edit.modelPost,
      result: state.ChargesGroup.edit.result,
      error: state.ChargesGroup.edit.error,
      loading: state.ChargesGroup.edit.loading,
      visible: state.ChargesGroup.edit.visible,
    },
    deletes: {
      modelPost: state.ChargesGroup.deletes.modelPost,
      result: state.ChargesGroup.deletes.result,
      error: state.ChargesGroup.deletes.error,
      loading: state.ChargesGroup.deletes.loading,
      visible: state.ChargesGroup.deletes.visible,
    },
    activates: {
      modelPost: state.ChargesGroup.activates.modelPost,
      result: state.ChargesGroup.activates.result,
      error: state.ChargesGroup.activates.error,
    },
    grd: {
      loading: state.ChargesGroup.grd.loading,
    },
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(ChargesGroup);
