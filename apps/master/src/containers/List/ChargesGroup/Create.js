    ...
    return (
      <Spin spinning={loading} size='large'>
        ...
        >
          <Form.Item
            name='Code'
            label={<FormattedMessage id='admin.chargesGroups.fields.code' />}
            rules={[
              {
                required: true,
                message: (
                  <FormattedMessage id='common.validators.inputFields.required' values={{ field: <FormattedMessage id='admin.chargesGroups.fields.code' /> }} />
                ),
              },
            ]}
          >
...
function mapStateToProps(state) {
  return {
    model: state.ChargesGroup.create.modelGet,
