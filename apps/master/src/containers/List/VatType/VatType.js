  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${vatTypeApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.vatType' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.vatTypes.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.vatTypes.fields.name' })} fixed={true} width={220} />
          ...
          <ContextMenu
            ...
            target='#grdVatType .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.vatTypes.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.vatTypes.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.VatType.loading,
    create: {
      modelGet: state.VatType.create.modelGet,
      modelPost: state.VatType.create.modelPost,
      result: state.VatType.create.result,
      error: state.VatType.create.error,
      loading: state.VatType.create.loading,
      visible: state.VatType.create.visible,
    },
    edit: {
      modelGet: state.VatType.edit.modelGet,
      modelPost: state.VatType.edit.modelPost,
      result: state.VatType.edit.result,
      error: state.VatType.edit.error,
      loading: state.VatType.edit.loading,
      visible: state.VatType.edit.visible,
      visibleSubmit: state.VatType.edit.visibleSubmit,
    },
    deletes: {
      modelPost: state.VatType.deletes.modelPost,
      result: state.VatType.deletes.result,
      error: state.VatType.deletes.error,
      loading: state.VatType.deletes.loading,
      visible: state.VatType.deletes.visible,
    },
    activates: {
      modelPost: state.VatType.activates.modelPost,
      result: state.VatType.activates.result,
      error: state.VatType.activates.error,
    },
    grd: {
      loading: state.VatType.grd.loading,
    },
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(VatType);
