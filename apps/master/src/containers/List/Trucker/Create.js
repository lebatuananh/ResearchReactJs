        ...
        <Tabs defaultActiveKey={tabSubmit} type='card' onChange={this.handleTabsChanged}>
          <TabPane tab={<FormattedMessage id='common.general' />} key='general'>
            ...
            >
              <Form.Item
                name='Code'
                label={<FormattedMessage id='admin.truckers.fields.code' />}
                rules={[
                  {
                    required: true,
                    message: (
                      <FormattedMessage id='common.validators.inputFields.required' values={{ field: <FormattedMessage id='admin.truckers.fields.code' /> }} />
                    ),
                  },
                ]}
              >
...
function mapStateToProps(state) {
  return {
    model: state.Trucker.create.modelGet,
