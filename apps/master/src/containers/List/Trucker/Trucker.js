  ...
  componentDidMount() {
    ...
    this.grd.dataSource = new CustomStore({
      ...
      load: (loadOptions) => {
        ...
        return fetch(`${truckerApi.get}?${params}`, { headers: headersHelper.def })
          .then(grd.errors)
    ...
    return (
      <Spin spinning={loading} size='large'>
        <LayoutContentWrapper>
          ...
          <Row style={rowStyle} gutter={gutter}>
            <Col span={9} style={colStyle}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <FormattedMessage id='common.trucker' />
                </Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          ...
          >
            <Column dataField='Code' dataType='string' caption={intl.formatMessage({ id: 'admin.truckers.fields.code' })} fixed={true} width={150} />
            <Column dataField='Name' dataType='string' caption={intl.formatMessage({ id: 'admin.truckers.fields.name' })} fixed={true} width={220} />
          ...
          <ContextMenu
            ...
            target='#grdTrucker .dx-datagrid-table tbody .dx-row.dx-data-row'
            width={180}
          ...
          <Modal
            title={<FormattedMessage id='admin.truckers.create' />}
          ...
          <Modal
            title={<FormattedMessage id='admin.truckers.edit' />}
...
function mapStateToProps(state) {
  return {
    ...
    loading: state.Trucker.loading,
    create: {
      modelGet: state.Trucker.create.modelGet,
      modelPost: state.Trucker.create.modelPost,
      result: state.Trucker.create.result,
      error: state.Trucker.create.error,
      loading: state.Trucker.create.loading,
      visible: state.Trucker.create.visible,
      visibleSubmit: state.Trucker.create.visibleSubmit,
    },
    edit: {
      modelGet: state.Trucker.edit.modelGet,
      modelPost: state.Trucker.edit.modelPost,
      result: state.Trucker.edit.result,
      error: state.Trucker.edit.error,
      loading: state.Trucker.edit.loading,
      visible: state.Trucker.edit.visible,
      visibleSubmit: state.Trucker.edit.visibleSubmit,
    },
    deletes: {
      modelPost: state.Trucker.deletes.modelPost,
      result: state.Trucker.deletes.result,
      error: state.Trucker.deletes.error,
      loading: state.Trucker.deletes.loading,
      visible: state.Trucker.deletes.visible,
    },
    activates: {
      modelPost: state.Trucker.activates.modelPost,
      result: state.Trucker.activates.result,
      error: state.Trucker.activates.error,
    },
    grd: {
      loading: state.Trucker.grd.loading,
    },
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(Trucker);
