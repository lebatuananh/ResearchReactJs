...
import service from '@shared/services/master/list/stateProvinceService';
...
async function initGetDataAsync() {
  return await Promise.all([service.getCountriesPromise(false)]);
}
//#endregion
...
export default function* stateProvinceSaga() {
  yield all([
