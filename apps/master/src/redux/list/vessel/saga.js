...
import service from '@shared/services/master/list/vesselService';
import modelHelper from '@shared/lib/helpers/modelHelper';
import countryService from '@shared/services/master/list/countryService';
...
async function initGetDataAsync() {
  return await Promise.all([countryService.getAllPromise(false)]);
}
//#endregion
...
export default function* vesselSaga() {
  yield all([
