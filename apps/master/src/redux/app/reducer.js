...
import { getDefaultPath } from '@shared/lib/helpers/url_sync';
import actions, { getView } from '@shared/redux-admin/app/actions';
import { isServer } from '@shared/lib/helpers/isServer';
const preKeys = getDefaultPath(MasterMenu, 'master');
